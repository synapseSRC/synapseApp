...
class GetProfilePhotosUseCase @Inject constructor(private val repository: ProfileRepository) {
    suspend operator fun invoke(userId: String, limit: Int = 20, offset: Int = 0): Result<List<Any>> {

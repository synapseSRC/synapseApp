                                    ...
                                    onSuccess = { user ->
                                        if (user != null) {
                                            CoroutineScope(Dispatchers.Main).launch {
                                                val intent = Intent(Intent.ACTION_VIEW, android.net.Uri.parse("synapse://profile/${user.uid}"))
                                                intent.setClass(context, com.synapse.social.studioasinc.feature.shared.main.MainActivity::class.java)

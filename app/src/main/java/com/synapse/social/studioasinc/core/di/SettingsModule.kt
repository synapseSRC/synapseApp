...
import com.synapse.social.studioasinc.shared.domain.usecase.settings.ShouldShowProfilePicSuggestionUseCase
...
object SettingsModule {
    ...
    @Provides
    @Singleton
    fun provideDataSettingsRepository(impl: SettingsRepositoryImpl): SettingsRepository {
        return impl
    }
    @Provides
    @Singleton
    fun provideSettingsRepository(@ApplicationContext context: Context): com.synapse.social.studioasinc.shared.domain.repository.SettingsRepository {
        return DomainSettingsRepositoryAdapter(SettingsRepositoryImpl.getInstance(context))
    }
    @Provides
    @Singleton
    fun provideShouldShowProfilePicSuggestionUseCase(
    ...
    ): com.synapse.social.studioasinc.shared.domain.usecase.settings.ShouldShowProfilePicSuggestionUseCase {
        return ShouldShowProfilePicSuggestionUseCase(authRepository, userRepository, settingsRepository)
    }
    @Provides
    @Singleton
    fun provideGetAppearanceSettingsUseCase(
        settingsRepository: com.synapse.social.studioasinc.shared.domain.repository.SettingsRepository
    ): com.synapse.social.studioasinc.shared.domain.usecase.settings.GetAppearanceSettingsUseCase {
        return GetAppearanceSettingsUseCase(settingsRepository)
    }
    @Provides
    @Singleton

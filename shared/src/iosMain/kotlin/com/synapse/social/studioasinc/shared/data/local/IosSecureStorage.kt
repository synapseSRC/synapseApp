...
class IosSecureStorage : SecureStorage {
    ...
    override fun save(key: String, value: String) {
        ...
        val attributesToUpdate = CFDictionaryCreateMutable(null, 0, null, null)
        CFDictionarySetValue(attributesToUpdate, kSecValueData, CFBridgingRetain(data))
    ...
    private fun keyChainQuery(key: String): CFMutableDictionaryRef? {
        ...
        CFDictionarySetValue(query, kSecAttrService, CFBridgingRetain(serviceName() as NSString))

...
import com.synapse.social.studioasinc.shared.util.toHexString
...
object S3Signer {
    ...
    fun signS3(
        ...
        val payloadToSign = payloadHash ?: "UNSIGNED-PAYLOAD"

        val canonicalHeaders = "content-type:${contentType.trim()}\n" +
                "host:${host.trim()}\n" +
                "x-amz-content-sha256:${payloadToSign.trim()}\n" +
        ...
        return mapOf(
            ...
            "x-amz-content-sha256" to payloadToSign,

...
interface ChatRepository {
    ...
    suspend fun sendMessage(chatId: String, content: String, mediaUrl: String? = null, messageType: String = "text", isEncrypted: Boolean = false, encryptedContent: String? = null, expiresAt: String? = null, replyToId: String? = null): Result<Message>

...
class UploadMediaUseCase(
    ...
    suspend operator fun invoke(
        ...
        // Keep repository.uploadMedia signature for interface compliance if needed,
        // but we actually return the url from mediaUploadRepository.
        // The original method in ChatRepository is deprecated by this usage.
        return result
    }
}

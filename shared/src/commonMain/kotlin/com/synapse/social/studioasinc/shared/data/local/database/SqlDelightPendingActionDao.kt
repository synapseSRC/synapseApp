...
class SqlDelightPendingActionDao(
    ...
    override suspend fun insert(action: PendingAction) = withContext(Dispatchers.IO) {
    ...
    override suspend fun update(id: String, retryCount: Int, lastAttemptAt: Long?) = withContext(Dispatchers.IO) {

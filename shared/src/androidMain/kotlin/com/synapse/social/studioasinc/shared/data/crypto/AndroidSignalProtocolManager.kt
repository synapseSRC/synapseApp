...
class AndroidSignalProtocolManager(context: Context) : SignalProtocolManager {
    ...
    override suspend fun deleteAllSessions() {
        Logger.d("E2EE_SESSION: Deleting all sessions", tag = "E2EE")
        store.deleteAllSessions(null)
        Logger.d("E2EE_SESSION: All sessions deleted", tag = "E2EE")
    }

    override suspend fun deleteIdentity(userId: String) {
        Logger.d("E2EE_SESSION: Deleting identity for user $userId", tag = "E2EE")
        val address = SignalProtocolAddress(userId, DEVICE_ID)
        store.deleteIdentity(address)
        Logger.d("E2EE_SESSION: Identity deleted for user $userId", tag = "E2EE")
    }
